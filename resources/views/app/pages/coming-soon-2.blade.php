        ...
        <div class="row align-items-center min-height-100vh">
            <div class="col-md-6 align-self-stretch p-0">
                <div class="image-frame h-100">
                    <div class="image-frame-wrapper">
                        <div class="image-frame-background min-height-370 appear-animation" data-appear-animation="scaleOut" data-appear-animation-duration="8s" data-plugin-image-background data-plugin-options="{'imageUrl': '/app-assets/img/others/coming-soon-bg-1.jpg'}"></div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 p-0">
                <header id="header" class="p-4 p-md-5">
                    <a href="index.html">
                        <img alt="EZ" width="127" height="20" src="/app-assets/img/logo.png" class="appear-animation" data-appear-animation="fadeInRightShorter" data-plugin-options="{'accY': 100}">
                    </a>
                </header>
                        ...
                        <div class="col-half-section pl-md-5">
                            <div role="main" class="main">
                                ...
                                <div class="overflow-hidden mb-2">
                                    <h1 class="font-weight-bold text-6 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="800">We Are Getting Ready to Launch!</h1>
                                </div>
                                <div class="overflow-hidden mb-5">
                                    <p class="text-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1000">Our website is almost ready to launch, lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. </p>
                                </div>
                                    ...
                                    <div class="card-body p-5">
                                        <div class="icon-box icon-box-style-1 align-items-center mb-0">
                                            <div class="icon-box-icon pr-2">
                                                <img width="60" src="/app-assets/img/icons/envelope.svg" alt="" data-icon data-plugin-options="{'color': '#FFF', 'animated': true, 'delay': 600}" />
                                            </div>
                                ...
                                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400">
                                    ...
                                    <div class="d-flex align-items-center my-2 my-lg-0">
                                        ...
                                        <a href="tel:+1234567890" class="font-weight-semibold">123-456-7890</a>
                                    </div>
                                    <div class="vertical-divider vertical-divider-size-1 opacity-4 d-none d-lg-block"></div>
                                    <div class="d-flex align-items-center">
                                        <i class="lnr lnr-envelope text-4 font-weight-bold text-color-primary mr-2"></i>
                                        <a href="mailto:you@domain.com" class="font-weight-semibold">you@domain.com</a>
                                    </div>
                                </div>
                            </div>
                            <footer id="footer" class="bg-transparent">
                                <p class="text-color-light-3 text-center text-lg-left appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600">Copyrights © 2018 All Rights Reserved by Okler</p>
                            </footer>
