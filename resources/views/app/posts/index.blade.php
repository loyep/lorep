...
<head>
    ...
    <link rel="apple-touch-icon" href="/app-assets/images/apple-touch-icon-57x57.png">
    ...
    <!-- et line icon -->
    <link rel="stylesheet" href="/app-assets/css/et-line-icons.css" />
    <!-- font-awesome icon -->
    ...
    <!-- justified gallery  -->
    <link rel="stylesheet" href="/app-assets/css/justified-gallery.min.css">
    <!-- magnific popup -->
    <link rel="stylesheet" href="/app-assets/css/magnific-popup.css" />
    <!-- revolution slider -->
    <link rel="stylesheet" type="text/css" href="/app-assets/revolution/css/settings.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="/app-assets/revolution/css/layers.css">
    <link rel="stylesheet" type="text/css" href="/app-assets/revolution/css/navigation.css">
    <!-- bootsnav -->
    <link rel="stylesheet" href="/app-assets/css/bootsnav.css">
    <!-- style -->
        ...
        <div class="container-fluid nav-header-container">
            <div class="row">
                ...
                <div class="col-md-2 col-xs-5">
                    <a href="index.html" title="Pofo" class="logo"><img src="/app-assets/images/logo.png" data-rjs="/app-assets/images/logo@2x.png" class="logo-dark" alt="Pofo"><img src="/app-assets/images/logo-white.png" data-rjs="/app-assets/images/logo-white@2x.png" alt="Pofo" class="logo-light default"></a>
                </div>
                <!-- end logo -->
                                ...
                                <div class="menu-back-div dropdown-menu megamenu-content mega-menu collapse mega-menu-full">
                                    <ul class="equalize sm-equalize-auto">
                                        ...
                                        <li class="mega-menu-column col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="home-creative-studio.html" class="menu-banner-image"><img src="/app-assets/images/menu-banner-01.png" alt="portfolio"/></a>
                                                </li>
                                                <li>
                                                    <a href="home-creative-business.html" class="menu-banner-image"><img src="/app-assets/images/menu-banner-02.png" alt="portfolio"/></a>
                                                </li>
                                            </ul>
                                            <!-- end sub menu item  -->
                                        </li>
...
<section class="wow fadeIn parallax" data-stellar-background-ratio="0.5" style="background-image:url('https://placehold.it/1920x1100');">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 extra-small-screen display-table page-title-large">
                <div class="display-table-cell vertical-align-middle text-center">
                    <!-- start page title -->
                    <h1 class="text-white alt-font font-weight-600 letter-spacing-minus-1 margin-10px-bottom">Blog list</h1>
        ...
        <div class="row">
            <main class="col-md-9 col-sm-12 col-xs-12 right-sidebar sm-margin-60px-bottom xs-margin-40px-bottom sm-padding-15px-lr">
                ...
                <div class="equalize sm-equalize-auto blog-post-content margin-60px-bottom padding-60px-bottom display-inline-block border-bottom border-color-extra-light-gray sm-margin-30px-bottom sm-padding-30px-bottom xs-text-center sm-no-border">
                    <div class="blog-image col-md-5 no-padding sm-margin-30px-bottom xs-margin-20px-bottom margin-45px-right sm-no-margin-right display-table">
                        <div class="display-table-cell vertical-align-middle">
                            <a href="blog-standard-post.html"><img src="https://placehold.it/1200x840" alt=""></a>
                        </div>
                    </div>
                ...
                <div class="equalize sm-equalize-auto blog-post-content margin-60px-bottom padding-60px-bottom display-inline-block border-bottom border-color-extra-light-gray sm-margin-30px-bottom sm-padding-30px-bottom xs-text-center sm-no-border">
                    <div class="blog-image col-md-5 no-padding sm-margin-30px-bottom xs-margin-20px-bottom margin-45px-right sm-no-margin-right display-table">
                        <div class="display-table-cell vertical-align-middle">
                            <a href="blog-gallery-post.html"><img src="https://placehold.it/1200x840" alt=""></a>
                        </div>
                    </div>
                    <div class="blog-text col-md-6 display-table no-padding">
                        <div class="display-table-cell vertical-align-middle">
                ...
                <div class="equalize sm-equalize-auto blog-post-content margin-60px-bottom padding-60px-bottom display-inline-block border-bottom border-color-extra-light-gray sm-margin-30px-bottom sm-padding-30px-bottom xs-text-center sm-no-border">
                    <div class="blog-image col-md-5 no-padding sm-margin-30px-bottom xs-margin-20px-bottom margin-45px-right sm-no-margin-right display-table">
                        <div class="display-table-cell vertical-align-middle">
                            <a href="blog-slider-post.html"><img src="https://placehold.it/1200x840" alt=""></a>
                        </div>
                    </div>
                    <div class="blog-text col-md-6 display-table no-padding">
                        <div class="display-table-cell vertical-align-middle">
                ...
                <div class="equalize sm-equalize-auto blog-post-content margin-60px-bottom padding-60px-bottom display-inline-block border-bottom border-color-extra-light-gray sm-margin-30px-bottom sm-padding-30px-bottom xs-text-center sm-no-border">
                    <div class="blog-image col-md-5 no-padding sm-margin-30px-bottom xs-margin-20px-bottom margin-45px-right sm-no-margin-right display-table">
                        <div class="display-table-cell vertical-align-middle">
                            <a href="blog-html5-video-post.html"><img src="https://placehold.it/1200x840" alt=""></a>
                        </div>
                    </div>
                    <div class="blog-text col-md-6 display-table no-padding">
                        <div class="display-table-cell vertical-align-middle">
                ...
                <div class="equalize sm-equalize-auto blog-post-content margin-60px-bottom padding-60px-bottom display-inline-block border-bottom border-color-extra-light-gray sm-margin-30px-bottom sm-padding-30px-bottom xs-text-center sm-no-border">
                    <div class="blog-image col-md-5 no-padding sm-margin-30px-bottom xs-margin-20px-bottom margin-45px-right sm-no-margin-right display-table">
                        <div class="display-table-cell vertical-align-middle">
                            <a href="blog-youtube-video-post.html"><img src="https://placehold.it/1200x840" alt=""></a>
                        </div>
                    </div>
                    <div class="blog-text col-md-6 display-table no-padding">
                        <div class="display-table-cell vertical-align-middle">
                ...
                <div class="equalize sm-equalize-auto blog-post-content margin-60px-bottom padding-60px-bottom display-inline-block border-bottom border-color-extra-light-gray sm-margin-30px-bottom sm-padding-30px-bottom xs-text-center sm-no-border">
                    <div class="blog-image col-md-5 no-padding sm-margin-30px-bottom xs-margin-20px-bottom margin-45px-right sm-no-margin-right display-table">
                        <div class="display-table-cell vertical-align-middle">
                            <a href="blog-vimeo-video-post.html"><img src="https://placehold.it/1200x840" alt=""></a>
                        </div>
                    </div>
                    <div class="blog-text col-md-6 display-table no-padding">
                        <div class="display-table-cell vertical-align-middle">
                            <div class="content margin-20px-bottom sm-no-padding-left ">
                                <a href="blog-vimeo-video-post.html" class="text-extra-dark-gray margin-5px-bottom alt-font text-extra-large font-weight-600 display-inline-block">Design is intelligence made visible</a>
                ...
                <div class="equalize sm-equalize-auto blog-post-content margin-60px-bottom padding-60px-bottom display-inline-block border-bottom border-color-extra-light-gray sm-margin-30px-bottom sm-padding-30px-bottom xs-text-center sm-no-border">
                    ...
                    <div class="blog-text col-md-6 display-table no-padding">
                        <div class="display-table-cell vertical-align-middle">
                            <div class="content margin-20px-bottom sm-no-padding-left ">
                                <a href="blog-standard-post.html" class="text-extra-dark-gray margin-5px-bottom alt-font text-extra-large font-weight-600 display-inline-block">Math is easy; design is hard</a>
                ...
                <div class="equalize sm-equalize-auto blog-post-content margin-60px-bottom padding-60px-bottom display-inline-block border-bottom border-color-extra-light-gray sm-margin-30px-bottom sm-padding-30px-bottom xs-text-center sm-no-border">
                    ...
                    <div class="blog-text col-md-6 display-table no-padding">
                        <div class="display-table-cell vertical-align-middle">
                            <div class="content margin-20px-bottom sm-no-padding-left ">
                                <a href="blog-html5-video-post.html" class="text-extra-dark-gray margin-5px-bottom alt-font text-extra-large font-weight-600 display-inline-block">The world’s business leaders</a>
                ...
                <div class="equalize sm-equalize-auto blog-post-contentpadding-60px-bottom display-inline-block sm-no-margin-bottom sm-no-padding-bottom xs-text-center">
                    <div class="blog-image col-md-5 no-padding sm-margin-30px-bottom xs-margin-20px-bottom margin-45px-right sm-no-margin-right display-table">
                        <div class="display-table-cell vertical-align-middle">
                            <a href="blog-blog-gallery-post.html-post.html"><img src="https://placehold.it/1200x840" alt=""></a>
                        </div>
                    </div>
                    <div class="blog-text col-md-6 display-table no-padding">
                        <div class="display-table-cell vertical-align-middle">
                            <div class="content margin-20px-bottom sm-no-padding-left ">
                                <a href="blog-blog-gallery-post.html-post.html" class="text-extra-dark-gray margin-5px-bottom alt-font text-extra-large font-weight-600 display-inline-block">Good design is good business</a>
                            ...
                            <a class="btn btn-very-small btn-dark-gray text-uppercase" href="blog-blog-gallery-post.html-post.html">Continue Reading</a>
                        </div>
                    </div>
                </div>
                <!-- end post item -->
            ...
            <aside class="col-md-3">
                ...
                <div class="margin-45px-bottom xs-margin-25px-bottom">
                    ...
                    <a href="about-me.html"><img src="https://placehold.it/800x533" alt="" class="margin-25px-bottom"/></a>
                ...
                <div class="margin-50px-bottom">
                    ...
                    <div class="social-icon-style-1 text-center">
                        <ul class="extra-small-icon">
                            ...
                            <li><a class="google" href="https://google.com" target="_blank"><i class="fab fa-google-plus-g"></i></a></li>
                            <li><a class="dribbble" href="https://dribbble.com" target="_blank"><i class="fab fa-dribbble"></i></a></li>
                            <li><a class="linkedin" href="https://linkedin.com" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="margin-45px-bottom xs-margin-25px-bottom">
                ...
                <div class="margin-45px-bottom xs-margin-25px-bottom">
                    ...
                    <ul class="latest-post position-relative">
                        <li>
                            <figure>
                                <a href="blog-post-layout-01.html"><img src="https://placehold.it/480x358" alt=""></a>
                            </figure>
                        ...
                        <li>
                            <figure>
                                <a href="blog-post-layout-02.html"><img src="https://placehold.it/480x358" alt=""></a>
                            </figure>
                        ...
                        <li>
                            <figure>
                                <a href="blog-post-layout-03.html"><img src="https://placehold.it/480x358" alt=""></a>
                            </figure>
                        ...
                        <li>
                            <figure>
                                <a href="blog-post-layout-04.html"><img src="https://placehold.it/480x358" alt=""></a>
                            </figure>
        ...
        <div class="container">
            <div class="row equalize xs-equalize-auto">
                ...
                <div class="col-md-4 col-sm-2 col-xs-12 text-center display-table xs-margin-10px-bottom">
                    <div class="display-table-cell vertical-align-middle">
                        <a href="index.html"><img class="footer-logo" src="/app-assets/images/logo-white.png" data-rjs="/app-assets/images/logo-white@2x.png" alt="Pofo"></a>
                    </div>
                </div>
                <!-- end logo -->
                <!-- start social media -->
    ...
    <div class="container">
        <div class="footer-bottom border-top border-color-medium-dark-gray padding-30px-top">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 text-right text-small xs-text-center">&COPY; 2017 POFO is Proudly Powered by <a href="https://www.themezaa.com" target="_blank" title="ThemeZaa">ThemeZaa</a></div>
                <!-- end copyright -->
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="/app-assets/js/modernizr.js"></script>
<script type="text/javascript" src="/app-assets/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/app-assets/js/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="/app-assets/js/skrollr.min.js"></script>
<script type="text/javascript" src="/app-assets/js/smooth-scroll.js"></script>
<script type="text/javascript" src="/app-assets/js/jquery.appear.js"></script>
<!-- menu navigation -->
<script type="text/javascript" src="/app-assets/js/bootsnav.js"></script>
<script type="text/javascript" src="/app-assets/js/jquery.nav.js"></script>
<!-- animation -->
<script type="text/javascript" src="/app-assets/js/wow.min.js"></script>
<!-- page scroll -->
<script type="text/javascript" src="/app-assets/js/page-scroll.js"></script>
<!-- swiper carousel -->
<script type="text/javascript" src="/app-assets/js/swiper.min.js"></script>
<!-- counter -->
<script type="text/javascript" src="/app-assets/js/jquery.count-to.js"></script>
<!-- parallax -->
<script type="text/javascript" src="/app-assets/js/jquery.stellar.js"></script>
<!-- magnific popup -->
<script type="text/javascript" src="/app-assets/js/jquery.magnific-popup.min.js"></script>
<!-- portfolio with shorting tab -->
<script type="text/javascript" src="/app-assets/js/isotope.pkgd.min.js"></script>
<!-- images loaded -->
<script type="text/javascript" src="/app-assets/js/imagesloaded.pkgd.min.js"></script>
<!-- pull menu -->
<script type="text/javascript" src="/app-assets/js/classie.js"></script>
<script type="text/javascript" src="/app-assets/js/hamburger-menu.js"></script>
<!-- counter  -->
<script type="text/javascript" src="/app-assets/js/counter.js"></script>
<!-- fit video  -->
<script type="text/javascript" src="/app-assets/js/jquery.fitvids.js"></script>
<!-- equalize -->
<script type="text/javascript" src="/app-assets/js/equalize.min.js"></script>
<!-- skill bars  -->
<script type="text/javascript" src="/app-assets/js/skill.bars.jquery.js"></script>
<!-- justified gallery  -->
<script type="text/javascript" src="/app-assets/js/justified-gallery.min.js"></script>
<!--pie chart-->
<script type="text/javascript" src="/app-assets/js/jquery.easypiechart.min.js"></script>
<!-- instagram -->
<script type="text/javascript" src="/app-assets/js/instafeed.min.js"></script>
<!-- retina -->
<script type="text/javascript" src="/app-assets/js/retina.min.js"></script>
<!-- revolution -->
<script type="text/javascript" src="/app-assets/revolution/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="/app-assets/revolution/js/jquery.themepunch.revolution.min.js"></script>
<!-- revolution slider extensions (load below extensions JS files only on local file systems to make the slider work! The following part can be removed on server for on demand loading) -->
<!--<script type="text/javascript" src="/app-assets/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script type="text/javascript" src="/app-assets/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script type="text/javascript" src="/app-assets/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script type="text/javascript" src="/app-assets/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript" src="/app-assets/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script type="text/javascript" src="/app-assets/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script type="text/javascript" src="/app-assets/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script type="text/javascript" src="/app-assets/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script type="text/javascript" src="/app-assets/revolution/js/extensions/revolution.extension.video.min.js"></script>-->
<!-- setting -->
