...
<div class="login-wrapper ">
    <div class="bg-pic">
        <img src="/assets/dashboard/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg"
             {{--data-src="/assets/dashboard/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg"--}}
             {{--data-src-retina="/assets/dashboard/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg"--}}
             alt="" class="lazy">
